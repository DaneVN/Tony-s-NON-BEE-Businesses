function TutorialPage() {
  return (
    <main>
      ...
      <p className="text-2xl text-(--cl-text-dark) w-3/4 mx-auto mt-16  text-center">
        Here you can find tutorials on how to use this platform.
      </p>
      <div
        id="youtube-videos"
        className="flex flex-col items-center w-3/4 mx-auto mt-10"
      >
        ...
        <div className="mb-8 text-center">
          ...
          <div className="aspect-w-16 aspect-h-9 flex justify-center">
            <iframe
              /** https://youtube.com/shorts/B5MFxqzB0p0?feature=share */
              src="https://www.youtube.com/embed/B5MFxqzB0p0"
